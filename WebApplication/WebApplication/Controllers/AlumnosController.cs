...
namespace webappacademica.Controllers
{
    ...
    {
        // Solución: El error CS0229 indica que hay dos campos o propiedades llamados '_context' en la clase 'AlumnosController'.
        // Para solucionarlo, revisa que solo exista una declaración de '_context'.
        // Si hay una declaración duplicada, elimina una de ellas.
        // En el código proporcionado, solo debe existir la siguiente línea:
